$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Shraddha and Deepak's Wedding",
...
// Google map
function initMap() {
    var location = {lat: 15.4312857, lng: 75.6343185}; // Updated location
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: location,
        scrollwheel: false
...
function initBBSRMap() {
    var la_fiesta = {lat: 15.4312857, lng: 75.6343185}; // Updated location
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
